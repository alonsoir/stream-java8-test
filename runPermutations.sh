...
clear && java -cp target/MyStreamjava8-1.0-RELEASE.jar com.aironman.Flattener "$1" >> flattened_output.txt

echo "Running print permutations"
while read linea;
do
	java -cp target/MyStreamjava8-1.0-RELEASE.jar com.aironman.PrintEveryPermutation $linea
