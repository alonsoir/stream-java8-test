...
./scripts/downloadPreviousResults.sh
...
PATH_TO_Primitiva=updatedPrimitiva.csv
# clear &&
...
java -cp stream-app.jar com.aironman.ApiStreamTests "$type" "$numIterations" "$PATH_TO_Euromillones2004_2018" "$PATH_TO_Primitiva" >> "output.txt"
...
java -jar jdbc-app.jar final_output_winners.txt final_output_star.txt
